...
class GiftedChat extends React.Component {
    constructor(props) {
        ...
        this.onMainViewLayout = (e) => {
            ...
            if (this.getMaxHeight() !== layout.height ||
                ...
                this.setMaxHeight(layout.height);
                this.setState({
                    messagesContainerHeight: this.getMessagesContainerHeightWithKeyboard(this.props.minComposerHeight),
                });
            }
    ...
    renderMessages() {
        ...
        <MessageContainer disableVirtualization={this.props.disableVirtualization} {...messagesContainerProps} invertibleScrollViewProps={this.invertibleScrollViewProps} messages={this.getMessages()} forwardRef={this._messageContainerRef} isTyping={this.props.isTyping}/>
        {this.renderChatFooter()}
      </View>);
        return this.props.isKeyboardInternallyHandled ? (<KeyboardAvoidingView style={{flex: 1}} enabled>{fragment}</KeyboardAvoidingView>) : (fragment);
    }
    resetInputToolbar() {
        if (this.textInput) {
